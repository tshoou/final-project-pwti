...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-lg-12"> 
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.profil.update', $profil->id_pegawai)}}" method="post" enctype="multipart/form-data">
                        @csrf
                  @method('patch')
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{route('admin.profil', Auth::user()->id_pegawai)}}" class="btn btn-warning">Kembali</a>
                  </div>
                </form>
              </div>
      </div>
