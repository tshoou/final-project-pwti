...
@section('section-header')
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="{{route('dokter.rekammedis',  Auth::user()->pegawai()->first()->id_pegawai) }}">Rekam Medis</a></div>
...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <a href="{{ route('dokter.rekammedis',  Auth::user()->pegawai()->first()->id_pegawai) }}" class="btn btn-primary">Kembali</a>
        </div>
