      ...
      <div class="col-8 col-sm-8 col-lg-8"> 
          <div class="card author-box card-primary">
              <div class="card-body">
                      ...
                      <a href="{{route('kasir.profil.edit', $d->id_pegawai)}}" class="btn">Edit Data Pribadi <i class="fas fa-chevron-right"></i></a>
...
<div class="modal fade" id="modalInsert" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('kasir.profil.updateFoto', $d->id_pegawai)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
