    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-12">
            <div class="card">
              ...
              <div class="col-md-6">
              <form action="{{route('resepsionist.obat.search')}}" method="get">
                <div class="input-group">
                  ...
                  <span class="input-group-prepend" style="position: relative; z-index: 0">
                    <a href="{{route('resepsionist.obat')}}" class="btn btn-warning">Reset</a>
                  </span>
                </div>
              </form>
              </div>
              ...
              <table class="table" id="data">
                ...
                <tr>
                    ...
                    <th> {{$o->harga}}</th>
                    <th>
                        <a href="{{route('resepsionist.obat.edit', $o->id_obat)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit"></i></a>
                        <a href="#" data-id="{{$o->id_obat}}" class="btn btn-icon btn-danger confirmation" data-toggle="tooltip" data-placement="top" title="Hapus">
                        <form style="display: none" action="{{route('resepsionist.obat.hapus', $o->id_obat)}}" method="POST" id="hapus{{$o->id_obat}}">
                            @csrf
                            @method('DELETE')
                        </form>
...
<div class="modal fade bd-example-modal-lg" id="modalInsert" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('resepsionist.obat.simpan')}}" method="POST">
            @csrf
            <div class="row">
              <div class="col-md-6">
