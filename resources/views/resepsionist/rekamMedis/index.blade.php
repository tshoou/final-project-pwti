  ...
  <div class="row">
      <div class="col-12 col-md-6 col-lg-12">
          <div class="card">
            ...
            <div class="col-md-6">
            <form action="{{route('resepsionist.rekammedis.search')}}" method="get">
            ...
            <table class="table" id="data">
              ...
              <tr>
                  ...
                  @endif
                  <th>
                      <a href="{{route('resepsionist.rekammedis.detail',$rekam->id_rekam_medis)}}" class="btn btn-icon btn-info" data-toggle="tooltip" data-placement="top" title="Details"><i class="fas fa-info"></i></a>
                      ...
                      <form style="display: none" action="{{route('resepsionist.rekammedis.hapus', $rekam->id_rekam_medis)}}" method="POST" id="hapus{{$rekam->id_rekam_medis}}">
                          @csrf
                          @method('DELETE')
                      </form>
